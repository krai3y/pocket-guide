...
<body>
<?php $activePage = 'places'; include '../header/header_cult_quest.php'; ?>
      ...
      <div class="container d-flex justify-content-center justify-content-sm-start"> 
        ...
        <div class="col text-center">
          <ul class="navbar-nav ms-0 ms-sm-4"> 
            ...
            <li class="nav-item"> 
              <a href="/routes/places_cult_quest" class="nav-link color-blue <?php echo ($activePage == 'places') ? 'active' : ''; ?>">Места «<?=$data[0]["route_name"]?>»</a> 
            </li>
          </ul>
        </div> 
      </div> 
