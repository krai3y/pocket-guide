...
<body>
<?php $activePage = 'places'; include '../header/header_way_to_past.php'; ?>
      ...
      <div class="container d-flex justify-content-center justify-content-sm-start"> 
        ...
        <div class="col text-center">
          <ul class="navbar-nav ms-0 ms-sm-4"> 
            ...
            <li class="nav-item"> 
              <a href="/routes/way_to_past" class="nav-link color-blue <?php echo ($activePage == 'map') ? 'active' : ''; ?>">Карта</a>
            </li> 
            <li class="nav-item"> 
              <a href="/routes/places_way_to_past" class="nav-link color-blue <?php echo ($activePage == 'places') ? 'active' : ''; ?>">Места «Путь в Прошлое»</a> 
            </li>
          </ul>
        </div> 
      </div> 
