...
<body>
<?php $activePage = 'places'; include '../header/header_forest_prost.php'; ?>
      ...
      <div class="container d-flex justify-content-center justify-content-sm-start"> 
        ...
        <div class="col text-center">
          <ul class="navbar-nav ms-0 ms-sm-4"> 
            ...
            <li class="nav-item"> 
              <a href="/routes/forest_prost" class="nav-link color-blue <?php echo ($activePage == 'map') ? 'active' : ''; ?>">Карта</a>
            </li> 
            <li class="nav-item"> 
              <a href="/routes/places_forest_prost" class="nav-link color-blue <?php echo ($activePage == 'places') ? 'active' : ''; ?>">Места «<?=$data[0]["route_name"]?>»</a> 
            </li>
          </ul>
        </div> 
      </div> 
